PYTUNE.Views.SocialPageLoginSignupView = Backbone.View.extend({
    ...
    open_in_pytune: function(e) {
        console.log(["open_in_pytune", e]);
        e.preventDefault();
        window.location.href = PYTUNE.URLs.pytune_page;
    },
    ...
    login: function() {
        ...
        PYTUNE.assets.login(username, password, _.bind(this.post_login, this), _.bind(this.login_error, this));
    },
    
    post_login: function(data) {
        PYTUNE.log(["login data", data]);
    ...
    logout: function(e) {
        e.preventDefault();
        PYTUNE.assets.logout(_.bind(this.post_logout, this), _.bind(this.logout_error, this));
    },
    ...
    signup: function() {
        ...
        PYTUNE.assets.signup(username, email, password, _.bind(this.post_signup, this), _.bind(this.signup_error, this));
    },
