PYTUNE.ReaderMarkRead = function(options) {
    var defaults = {
        days: 1,
...
PYTUNE.ReaderMarkRead.prototype = new PYTUNE.Modal;
PYTUNE.ReaderMarkRead.prototype.constructor = PYTUNE.ReaderMarkRead;

_.extend(PYTUNE.ReaderMarkRead.prototype, {
