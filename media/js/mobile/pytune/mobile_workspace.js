    ...
    PYTUNE.MobileReader.prototype = {
        ...
        colorize_story_title: function() {
            ...
            $('.ui-header', this.pages.story)
                .css('background-image',   PYTUNE.utils.generate_gradient(feed, 'webkit'))
                .css('background-image',   PYTUNE.utils.generate_gradient(feed, 'moz'))
                .css('borderBottom',       PYTUNE.utils.generate_gradient(feed, 'border'))
                .css('borderTop',          PYTUNE.utils.generate_gradient(feed, 'border'))
                .toggleClass('NB-inverse', PYTUNE.utils.is_feed_floater_gradient_light(feed));
        ...
        story_color: function(story) {
            var score = PYTUNE.utils.compute_story_score(story);
