...
PLANS = [
    ("pytune-premium-12", mark_safe("$12 / year <span class='NB-small'>($1/month)</span>")),
    ("pytune-premium-24", mark_safe("$24 / year <span class='NB-small'>($2/month)</span>")),
    ("pytune-premium-36", mark_safe("$36 / year <span class='NB-small'>($3/month)</span>")),
]
...
class RedeemCodeForm(forms.Form):
    ...
    def clean_gift_code(self):
        ...
        if pytune_gift_code:
            ...
            return pytune_gift_code.gift_code
        else:
