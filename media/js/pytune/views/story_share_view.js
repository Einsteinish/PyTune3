PYTUNE.Views.StoryShareView = Backbone.View.extend({
    ...
    toggle_feed_story_share_dialog: function(options) {
        ...
        if (options.close ||
            ...
            if (options.animate_scroll) {
                var $scroll_container = PYTUNE.reader.$s.$story_titles;
    ...
    resize: function(options) {
        ...
        if (!PYTUNE.reader.flags.narrow_content &&
        ...
        } else if (!PYTUNE.reader.flags.narrow_content) {
    ...
    mark_story_as_shared: function(options) {
        ...
        } else if (_.contains(['river:pytuneblogs', 'river:global'], PYTUNE.reader.active_feed)) {
    ...
    post_share_story: function(shared, data) {
        ...
        if (this.options.on_social_page) {
            ...
            PYTUNE.reader.hide_confirm_story_share_menu_item(true);
        }
