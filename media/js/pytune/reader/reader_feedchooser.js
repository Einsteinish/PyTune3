PYTUNE.ReaderFeedchooser = function(options) {
    options = options || {};
    var defaults = {
        ...
        'onClose': _.bind(function() {
            if (!this.flags['has_saved'] && !this.model.flags['has_chosen_feeds']) {
                PYTUNE.reader.show_feed_chooser_button();
            }
...
PYTUNE.ReaderFeedchooser.prototype = new PYTUNE.Modal;
PYTUNE.ReaderFeedchooser.prototype.constructor = PYTUNE.ReaderFeedchooser;

_.extend(PYTUNE.ReaderFeedchooser.prototype, {
    ...
    runner: function() {
        ...
        PYTUNE.assets.feeds.each(function(feed) {
    ...
    make_modal: function() {
        ...
        this.$modal = $.make('div', { className: 'NB-modal-feedchooser NB-modal ' + (this.options.premium_only ? "NB-feedchooser-premium" : this.options.chooser_only ? "NB-feedchooser-chooser-only" : "NB-feedchooser-standard") }, [
            ...
            (!this.options.chooser_only && $.make('div', { className: 'NB-feedchooser-type NB-right' }, [
              ...
              (PYTUNE.Globals.is_premium && $.make('div', { className: 'NB-feedchooser-info'}, [
                  ...
                  $.make('h2', { className: 'NB-modal-subtitle' }, [
                      ...
                      (PYTUNE.Globals.premium_expire < new Date) ? 
              ...
              $.make('ul', { className: 'NB-feedchooser-premium-bullets' }, [
                ...
                $.make('li', { className: 'NB-6' }, [
                  $.make('div', { className: 'NB-feedchooser-premium-bullet-image' }),
                  'Privacy options for your pytuneblog'
                ]),
                ...
                $.make('li', { className: 'NB-9' }, [
                  ...
                  $.make('img', { className: 'NB-feedchooser-premium-poor-hungry-dog', src: PYTUNE.Globals.MEDIA_URL + '/img/reader/shiloh.jpg' })
                ])
              ]),
              $.make('div', { className: 'NB-modal-submit NB-modal-submit-paypal' }, [
                  ...
                  $.make('div', { className: 'NB-feedchooser-dollar' }, [
                      $.make('div', { className: 'NB-feedchooser-dollar-value NB-2' }, [
                          $.make('div', { className: 'NB-feedchooser-dollar-month' }, [
                            $.make('div', { className: 'NB-feedchooser-dollar-image' }, [
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold16.png', style: "position: absolute; left: -56px;top: 15px;width: 16px;" }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold24.png', style: "position: absolute; left: -31px;top: 10px; width: 24px;" }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold32.png', style: "position: absolute; left: 0; top: 6px; width: 32px" })
                            ]),
                            '$24/year'
                          ]),
                      ...
                      $.make('div', { className: 'NB-feedchooser-dollar-value NB-3' }, [
                          $.make('div', { className: 'NB-feedchooser-dollar-month' }, [
                            $.make('div', { className: 'NB-feedchooser-dollar-image' }, [
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold24.png', style: "position: absolute; left: -68px;top: 11px;width: 24px;" }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold32.png', style: "position: absolute; left: -42px;top: 7px; width: 32px;" }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_coffeecup_gold40.png', style: "position: absolute; left: -8px; top: 4px; width: 40px" })
                            ]),
                            '$36/year'
                          ]),
                  ...
                  $.make('div', { className: 'NB-feedchooser-processor' }, [
                      $.make('div', { className: 'NB-feedchooser-paypal' }, [
                        $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/logo-paypal.png', height: 30 }),
                        $.make('div', { className: 'NB-feedchooser-paypal-form' })
                      ]),
                      $.make('div', { className: 'NB-feedchooser-stripe' }, [
                        $.make('div', { className: 'NB-creditcards' }, [
                            $.make('img', { src: PYTUNE.Globals.MEDIA_URL + "/img/reader/cc_visa.png" }),
                            $.make('img', { src: PYTUNE.Globals.MEDIA_URL + "/img/reader/cc_mastercard.png" }),
                            $.make('img', { src: PYTUNE.Globals.MEDIA_URL + "/img/reader/cc_amex.png" }),
                            $.make('img', { src: PYTUNE.Globals.MEDIA_URL + "/img/reader/cc_discover.png" })
                        ]),
                        $.make('div', { 
    ...
    make_feeds: function() {
        ...
        this.feed_count = _.unique(PYTUNE.assets.folders.feed_ids_in_folder(true)).length;
        
        this.feedlist = new PYTUNE.Views.FeedList({
            feed_chooser: true,
        ...
        PYTUNE.assets.folders.sort();
        
        PYTUNE.assets.feeds.off('change:highlighted')
    ...
    close_and_add: function() {
        $.modal.close(function() {
            PYTUNE.add_feed = new PYTUNE.ReaderAddFeed();
        });
    },
    
    open_stripe_form: function() {
        window.location.href = "https://" + PYTUNE.URLs.domain + "/profile/stripe_form?plan=" + this.plan;
    },
