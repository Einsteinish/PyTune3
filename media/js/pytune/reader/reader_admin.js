PYTUNE.ReaderUserAdmin = function(options) {
    var defaults = {
        width: 700
    };
...
PYTUNE.ReaderUserAdmin.prototype = new PYTUNE.Modal;
PYTUNE.ReaderUserAdmin.prototype.constructor = PYTUNE.ReaderUserAdmin;

_.extend(PYTUNE.ReaderUserAdmin.prototype, {
    ...
    make_modal: function() {
        ...
        this.$modal = $.make('div', { className: 'NB-modal-admin NB-modal' }, [
            ...
            new PYTUNE.Views.SocialProfileBadge({
                model: this.user
            }),
            $.make('fieldset', [
    ...
    handle_click: function(elem, e) {
        ...
        $.targetIs(e, { tagSelector: '.NB-admin-action-never-expire' }, function($t, $p) {
            ...
            PYTUNE.assets.never_expire_premium({
                'user_id': self.user.get('user_id')
            }, function(data) {
        ...
        $.targetIs(e, { tagSelector: '.NB-admin-action-upgrade' }, function($t, $p) {
            ...
            PYTUNE.assets.upgrade_premium(self.user.get('user_id'), function() {
        ...
        $.targetIs(e, { tagSelector: '.NB-admin-action-history' }, function($t, $p) {
            ...
            PYTUNE.assets.update_payment_history(self.user.get('user_id'), function() {
        ...
        $.targetIs(e, { tagSelector: '.NB-admin-action-opml' }, function($t, $p) {
            ...
            window.location.href = PYTUNE.URLs['opml-export'] + "?user_id=" + self.user.get('user_id');
        });
