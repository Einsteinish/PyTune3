PYTUNE.Views.FollowRequestsModule = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        PYTUNE.assets.user_profile.bind('change:protected', this.start_polling);
    },
    
    start_polling: function() {
        if (PYTUNE.assets.user_profile.get('protected') && 
    ...
    fetch_follow_requests: function() {
        PYTUNE.assets.fetch_follow_requests(_.bind(function(data) {
