...
LOG_FILE      = os.path.join(CURRENT_DIR, 'logs/pytune.log')
...
DEBUG_QUERIES         = False
MANAGERS              = ADMINS
PAYPAL_RECEIVER_EMAIL = 'khongpay@sf.com'
TIME_ZONE             = 'GMT'
LANGUAGE_CODE         = 'en-us'
SITE_ID               = 1
USE_I18N              = False
...
# CORS_ORIGIN_REGEX_WHITELIST = ('^(https?://)?(\w+\.)?pytune\.com$', )
...
OAUTH2_PROVIDER = {
    'SCOPES': {
        ...
        'ifttt': 'Pair your PyTune account with other IFTTT channels.',
    },
...
AUTH_PROFILE_MODULE     = 'pytune.UserProfile'
TEST_DATABASE_COLLATION = 'utf8_general_ci'
TEST_DATABASE_NAME      = 'pytune_test'
ROOT_URLCONF            = 'urls'
...
ELASTICSEARCH_FEED_HOSTS = ['lcoalhost:9200']
ELASTICSEARCH_STORY_HOSTS = ['localhost:9200']
...
S3_PAGES_BUCKET_NAME = 'pages.pytune.com'
S3_ICONS_BUCKET_NAME = 'icons.pytune.com'
S3_AVATARS_BUCKET_NAME = 'avatars.pytune.com'
