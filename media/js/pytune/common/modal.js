...
PYTUNE.Modal.prototype = {
    ...
    make_feed_chooser: function(options) {
        ...
        var $social_feeds_optgroup = $.make('optgroup', { label: "Pytuneblogs" });
    ...
    initialize_folder: function(folder_title) {
        ...
        $('.NB-modal-subtitle .NB-modal-feed-image', this.$modal).attr('src', PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_folder.png');
