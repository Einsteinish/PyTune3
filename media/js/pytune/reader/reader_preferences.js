...
PYTUNE.ReaderPreferences = function(options) {
    var defaults = {
        width: 700
    };
...
PYTUNE.ReaderPreferences.prototype = new PYTUNE.Modal;
PYTUNE.ReaderPreferences.prototype.constructor = PYTUNE.ReaderPreferences;

_.extend(PYTUNE.ReaderPreferences.prototype, {
            ...
            $.make('form', { className: 'NB-preferences-form' }, [
                $.make('div', { className: 'NB-tab NB-tab-general NB-active' }, [
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            ...
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-ssl-2' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/g_icn_lock.png' }),
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-autoopenfolder-1' }, [
                                    'Show the dashboard when loading PyTune'
                                ])
                            ]),
                            $.make('div', [
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-animations-1' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/arrow_in.png' }),
                                    'Show all animations'
                                ])
                            ]),
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-animations-2' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/arrow_right.png' }),
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-feedorder-1' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/pilcrow.png' }),
                                    'Alphabetical'
                                ])
                            ]),
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-feedorder-2' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/report_user.png' }),
                    ...
                    $.make('div', { className: 'NB-preference NB-preference-opml' }, [
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('a', { className: 'NB-splash-link', href: PYTUNE.URLs['opml-export'] }, 'Download OPML')
                        ]),
                        $.make('div', { className: 'NB-preference-label'}, [
                            'Backup your sites',
                        ...
                        $.make('div', { className: 'NB-preference-options NB-view-settings' }, [
                            $.make('div', { className: "" }, [
                                $.make('label', { 'for': 'NB-preference-layout-1' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_full_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-layout-2' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_split_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-layout-3' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_list_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-layout-4' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_grid_active.png' }),
                        ...
                        $.make('div', { className: 'NB-preference-options NB-view-settings' }, [
                            $.make('div', { className: "NB-view-setting-original" }, [
                                $.make('label', { 'for': 'NB-preference-view-1' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_original_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-view-2' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_feed_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-view-3' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_text_active.png' }),
                            ...
                            $.make('div', [
                                $.make('label', { 'for': 'NB-preference-view-4' }, [
                                    ...
                                    $.make("img", { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/circular/nav_story_story_active.png' }),
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-window-1' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/application_view_gallery.png' }),
                                    'In this window'
                                ])
                            ]),
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-window-2' }, [
                                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/icons/silk/application_side_expand.png' }),
                                    'In a new window'
                                ])
                            ])
                        ]),
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-truncatestory-1' }, [
                                    'Only truncate long shared stories in pytuneblogs'
                                ])
                            ]),
                            $.make('div', [
                ...
                $.make('div', { className: 'NB-tab NB-tab-keyboard' }, [
                    (!PYTUNE.Globals.is_premium && $.make('div', { className: 'NB-preferences-notpremium' }, [
                        'You must have a ',
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                $.make('input', { 
                                    ...
                                    value: 'view',
                                    disabled: !PYTUNE.Globals.is_premium
                                }),
                        ...
                        $.make('div', { className: 'NB-preference-options' }, [
                            ...
                            $.make('div', [
                                ...
                                $.make('label', { 'for': 'NB-preference-keyboard-verticalarrows-2' }, [
                                    ...
                                    'px.',
                                    $.make('input', { name: 'arrow_scroll_spacing', value: PYTUNE.Preferences.arrow_scroll_spacing, type: 'hidden' })
                                ])
                            ])
                        ]),
                        $.make('div', { className: 'NB-preference-label'}, [
                    ...
                    $.make('div', { className: 'NB-preference NB-preference-keyboard-spacebar' }, [
                        $.make('div', { className: 'NB-preference-options' }, [
                            $.make('div', [
                                ...
                                ' of the screen',
                                $.make('input', { name: 'space_scroll_spacing', value: PYTUNE.Preferences.space_scroll_spacing, type: 'hidden' })
                            ]),
    ...
    make_autoopen_folders: function() {
        var autoopen_folder = PYTUNE.Preferences.autoopen_folder;
        var $folders = PYTUNE.utils.make_folders(autoopen_folder, {
            name: 'default_folder',
    ...
    select_preferences: function() {
        ...
        if (PYTUNE.Preferences.timezone) {
            $('select[name=timezone] option', $modal).each(function() {
                if ($(this).val() == PYTUNE.Preferences.timezone) {
        ...
        $('select[name=default_folder] option', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.default_folder) {
                $(this).attr('selected', true);
                return false;
            }
        });
        $('input[name=story_layout]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.story_layout) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=default_view]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.default_view) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=new_window]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.new_window) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=feed_order]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.feed_order) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=ssl]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.ssl) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=autoopen_folder]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.autoopen_folder) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=title_counts]', $modal).each(function() {
            if (PYTUNE.Preferences.title_counts) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=open_feed_action]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.open_feed_action) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=mark_read_on_scroll_titles]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.mark_read_on_scroll_titles) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=show_content_preview]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.show_content_preview) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=show_image_preview]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.show_image_preview) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=doubleclick_feed]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.doubleclick_feed) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=doubleclick_unread]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.doubleclick_unread) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=mark_read_river_confirm]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.mark_read_river_confirm) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=markread_nextfeed]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.markread_nextfeed) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=read_story_delay]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.read_story_delay) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=full_width_story]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.full_width_story) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=truncate_story]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.truncate_story) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=animations]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.animations) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=dateformat]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.dateformat) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=folder_counts]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.folder_counts) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=show_tooltips]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.show_tooltips) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=show_contextmenus]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.show_contextmenus) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=hide_public_comments]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.hide_public_comments) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=story_button_placement]', $modal).each(function() {
            if ($(this).val() == ""+PYTUNE.Preferences.story_button_placement) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=keyboard_verticalarrows]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.keyboard_verticalarrows) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=keyboard_horizontalarrows]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.keyboard_horizontalarrows) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=space_bar_action]', $modal).each(function() {
            if ($(this).val() == PYTUNE.Preferences.space_bar_action) {
                $(this).attr('checked', true);
                return false;
            }
        });
        $('input[name=arrow_scroll_spacing]', $modal).val(PYTUNE.Preferences.arrow_scroll_spacing);
        $('input[name=space_scroll_spacing]', $modal).val(PYTUNE.Preferences.space_scroll_spacing);
        
        var order = PYTUNE.Preferences['default_order'];
        var read_filter = PYTUNE.Preferences['default_read_filter'];
        ...
        var share_preferences = _.select(_.keys(PYTUNE.Preferences), function(p) { 
            return p.indexOf('story_share') != -1; 
        });
        _.each(share_preferences, function(share) {
            var share_name = share.match(/story_share_(.*)/)[1];
            $('input#NB-preference-story-share-'+share_name, $modal).attr('checked', PYTUNE.Preferences[share]);
        });
        ...
        $(".NB-tangle-readstorydelay", $modal).slider({
            ...
            max: 60,
            step: 1,
            value: PYTUNE.Preferences.read_story_delay > 0 ? PYTUNE.Preferences.read_story_delay : 1,
        ...
        $(".NB-tangle-arrowscrollspacing-control", $modal).slider({
            ...
            max: 500,
            step: 20,
            value: PYTUNE.Preferences.arrow_scroll_spacing,
        ...
        $(".NB-tangle-spacescrollspacing-control", $modal).slider({
            ...
            max: 100,
            step: 10,
            value: PYTUNE.Preferences.space_scroll_spacing,
    ...
    slide_read_story_delay_slider: function(e, ui) {
        var value = (ui && ui.value) ||
                    (PYTUNE.Preferences.read_story_delay > 0 ? PYTUNE.Preferences.read_story_delay : 1);
        $(".NB-tangle-seconds", this.$modal).text(value == 1 ? value + ' second.' : value + ' seconds.');
        if (PYTUNE.Preferences.read_story_delay > 0 || ui) {
    ...
    slide_arrow_scroll_spacing_slider: function(e, ui) {
        var value = (ui && ui.value) || PYTUNE.Preferences.arrow_scroll_spacing;
        ...
        if (PYTUNE.Preferences.keyboard_verticalarrows == 'scroll' || ui) {
    ...
    slide_space_scroll_spacing_slider: function(e, ui) {
        var value = (ui && ui.value) || PYTUNE.Preferences.space_scroll_spacing;
        if (!PYTUNE.Globals.is_premium) {
            value = PYTUNE.Preferences.space_scroll_spacing;
        }
    ...
    save_preferences: function() {
        ...
        this.model.save_preferences(form, function(data) {
            PYTUNE.reader.switch_feed_view_unread_view();
            PYTUNE.reader.apply_story_styling(true);
            PYTUNE.reader.apply_tipsy_titles();
            PYTUNE.reader.adjust_for_narrow_window();
            PYTUNE.reader.add_body_classes();
            ...
            if (self.original_preferences['ssl'] != form['ssl']) {
                PYTUNE.reader.check_and_load_ssl();
            }
            self.close();
        });
    },
    ...
    close_and_load_account: function() {
      this.close(function() {
          PYTUNE.reader.open_account_modal();
      });
    },
    
    close_and_load_feedchooser: function() {
        this.close(function() {
            PYTUNE.reader.open_feedchooser_modal();
        });
    },
    ...
    clear_overrides: function(type) {
        ...
        PYTUNE.assets.clear_view_settings(type, _.bind(function(data) {
