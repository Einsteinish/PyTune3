PYTUNE.ReaderTutorial = function(options) {
    var defaults = {};
...
PYTUNE.ReaderTutorial.prototype = new PYTUNE.Modal;
PYTUNE.ReaderTutorial.prototype.constructor = PYTUNE.ReaderTutorial;

_.extend(PYTUNE.ReaderTutorial.prototype, {
    ...
    load_pytune_blog_info: function() {
      this.model.load_tutorial({}, _.bind(function(data) {
        this.pytune_feed = data.pytune_feed;
    ...
    make_modal: function() {
        ...
        this.$modal = $.make('div', { className: 'NB-modal-tutorial NB-modal' }, [
            ...
            $.make('div', { className: 'NB-page NB-page-1' }, [
              $.make('h4', 'PyTune is a visual feed reader with intelligence.'),
              $.make('div', 'You\'ll figure out much of PyTune by playing around and trying things out. This tutorial is here to quickly offer a foundation.'),
              ...
              $.make('h4', 'Why you should use PyTune:'),
              $.make('ul', [
                $.make('li', [
                ...
                $.make('li', [
                  'Spend less time as PyTune filters the stories for you.'
                ])
              ])
            ]),
            $.make('div', { className: 'NB-page NB-page-2' }, [
              ...
              $.make('div', { className: 'NB-tutorial-view' }, [
                $.make('div', { className: 'NB-tutorial-view-title' }, [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/application_view_tile.png' }),
                  'Original'
                ]),
                $.make('img', { className: 'NB-tutorial-view-image', src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_view_original.png' }),
                $.make('span', 'The site itself.')
              ]),
              $.make('div', { className: 'NB-tutorial-view' }, [
                $.make('div', { className: 'NB-tutorial-view-title' }, [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/application_view_list.png' }),
                  'Feed'
                ]),
                $.make('img', { className: 'NB-tutorial-view-image', src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_view_feed.png' }),
              ...
              $.make('div', { className: 'NB-tutorial-view' }, [
                ...
                $.make('img', { className: 'NB-tutorial-view-image', src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_view_story.png' }),
            ...
            $.make('div', { className: 'NB-page NB-page-3' }, [
              $.make('h4', 'PyTune works best when you use intelligence classifiers.'),
              $.make('ul', [
                $.make('li', { className: 'NB-tutorial-train-1' }, [
                  $.make('b', 'First: Train stories and sites.'),
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_train_feed.png' }),
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_train_story.png' })
                ]),
                $.make('li', [
                  ...
                  $.make('img', { className: 'NB-trainer-bullet', src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/bullet_green.png'}),
                  ' are stories you like',
                  $.make('br'),
                  $.make('img', { className: 'NB-trainer-bullet', src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_unread.png'}),
                  ' are stories you have not yet rated',
                  $.make('br'),
                  $.make('img', { className: 'NB-trainer-bullet', src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/bullet_red.png'}),
                    ...
                    $.make('div', { className: 'NB-intelligence-slider' }, [
                        $.make('ul', { className: 'segmented-control' }, [
                            $.make('li', { className: 'NB-intelligence-slider-control NB-intelligence-slider-red' }, [
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/bullet_red.png' }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/circular/g_icn_unread.png' }),
                                $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/icons/silk/bullet_green.png' })
                            ]),
            ...
            $.make('div', { className: 'NB-page NB-page-4' }, [
              ...
              $.make('ul', [
                $.make('li', { className: 'NB-tutorial-tips-sites' }, [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_tips_sites.png' }),
                  $.make('div', [
                    'Click on the sites count at the top of the sidebar to hide sites with no unread stories.'
                  ])
                ]),
                $.make('li', [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_tips_instafetch.png' }),
                  'Instantly refresh a site by right-clicking on it and selecting ',
                  $.make('b', 'Insta-fetch stories.')
                ]),
                $.make('li', [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_tips_stories.png' }),
                  'Click the arrow next to sites and stories to open up a menu.'
                ]),
                $.make('li', { className: 'NB-tutorial-tips-train' }, [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_tips_train.png' }),
                ...
                $.make('li', [
                  $.make('img', { src: PYTUNE.Globals.MEDIA_URL + '/img/reader/tutorial_tips_folders.png' }),
            ...
            $.make('div', { className: 'NB-page NB-page-5' }, [
              ...
              $.make('ul', [
                $.make('li', [
                  $.make('a', { href: 'http://getsatisfaction.com/pytune', className: 'NB-splash-link' }, [
                    'PyTune on ',
                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/reader/getsatisfaction.png', style: 'vertical-align: middle;margin: -2px 0 0; width: 16px;height: 16px;' }),
                    ' Get Satisfaction'
                  ])
                ])
              ]),
              ...
              $.make('h4', { className: 'NB-tutorial-feedback-header' }, 'The PyTune Blog'),
              $.make('ul', [
                $.make('li', [
                  $.make('div', { className: 'NB-modal-submit-button NB-modal-submit-green NB-javascript NB-tutorial-finish-pytune-blog', style: 'float: right;margin-top: -2px' }, [
                    'Finish Tutorial and Load',
                    $.make('img', { src: PYTUNE.Globals.MEDIA_URL+'/img/favicon_32.png', style: "margin: -3px 0px 0px 4px; vertical-align: middle;width: 16px;height: 16px;" }),
                    ' the PyTune Blog ',
    ...
    make_story_titles: function() {
      ...
      var stories = [
        ...
        ['PyTune becomes #1 feed reader', '',         '',       'positive'],
    ...
    close: function() {
      ...
      PYTUNE.Modal.prototype.close.call(this);
    },
