PYTUNE.ReaderKeyboard = function(options) {
    var defaults = {
        width: 700
    };
...
PYTUNE.ReaderKeyboard.prototype = new PYTUNE.Modal;
PYTUNE.ReaderKeyboard.prototype.constructor = PYTUNE.ReaderKeyboard;

_.extend(PYTUNE.ReaderKeyboard.prototype, {
