PYTUNE.ReaderGoodies = function(options) {
    var defaults = {};
...
PYTUNE.ReaderGoodies.prototype = new PYTUNE.Modal;
PYTUNE.ReaderGoodies.prototype.constructor = PYTUNE.ReaderGoodies;

_.extend(PYTUNE.ReaderGoodies.prototype, {
    ...
    make_modal: function() {
        ...
        this.$modal = $.make('div', { className: 'NB-modal-goodies NB-modal' }, [
            ...
            $.make('fieldset', [
                $.make('legend', 'Mobile Apps for PyTune')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              ...
              $.make('div', { className: 'NB-goodies-title' }, 'Official PyTune iPhone/iPad App')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-goodies-mobile-link NB-modal-submit-button NB-modal-submit-green',
              ...
              $.make('div', { className: 'NB-goodies-title' }, 'Official PyTune Android App')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-goodies-mobile-link NB-modal-submit-button NB-modal-submit-green',
            ...
            $.make('fieldset', [
                $.make('legend', 'Browser Extensions for PyTune')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
              ...
              $.make('div', { className: 'NB-goodies-title' }, 'Firefox: Register PyTune as an RSS reader')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-modal-submit-button NB-modal-submit-green',
                  href: 'https://addons.mozilla.org/en-US/firefox/addon/pytunecom-notifier/'
              }, 'Download'),
              $.make('div', { className: 'NB-goodies-firefox' }),
              $.make('div', { className: 'NB-goodies-title' }, 'Firefox: PyTune Notifier'),
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              ...
              $.make('div', { className: 'NB-goodies-subtitle' }, [
                  $.make('ul', [
                      ...
                      $.make('li', 'Go to PyTune and open a story with \'o\' and see it load in the background')
                  ])
              ])
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              ...
              $.make('div', { className: 'NB-goodies-title' }, 'Google Chrome: Register PyTune as an RSS reader'),
              $.make('div', { className: 'NB-goodies-subtitle' }, [
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              ...
              $.make('div', { className: 'NB-goodies-chrome' }),
              $.make('div', { className: 'NB-goodies-title' }, 'Google Chrome: PyTune Chrome Web App'),
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              ...
              $.make('div', { className: 'NB-goodies-chrome' }),
              $.make('div', { className: 'NB-goodies-title' }, 'Chrome: PyTune unread count notifier'),
              $.make('div', { className: 'NB-goodies-subtitle' }, 'Shows the unread count from your PyTune account.')
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-modal-submit-button NB-modal-submit-green',
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-modal-submit-button NB-modal-submit-green',
                  href: 'https://chrome.google.com/webstore/detail/unofficial-pytune-reade/hnegmjknmfninedmmlhndnjlblopjgad?utm_campaign=en&utm_source=en-ha-na-us-bk-webstr&utm_medium=ha'
              }, 'Download'),
              $.make('div', { className: 'NB-goodies-chrome' }),
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-modal-submit-button NB-modal-submit-green',
                  href: PYTUNE.Globals.MEDIA_URL + 'extensions/PyTune Safari Helper.app.zip'
              }, 'Add to Safari'),
              $.make('div', { className: 'NB-goodies-safari' }),
              $.make('div', { className: 'NB-goodies-title' }, 'Safari: Register PyTune as an RSS reader'),
              $.make('div', { className: 'NB-goodies-subtitle' }, [
                'To use this extension, extract and move the PyTune Safari Helper.app ',
                'to your Applications folder. Then in ',
                $.make('b', 'Safari > Settings > RSS'),
                ' choose the new PyTune Safari Helper.app. If you don\'t have an RSS chooser, ',
                'you will have to use ',
                $.make('a', { href: 'http://www.rubicode.com/Software/RCDefaultApp/', className: 'NB-splash-link' }, 'RCDefaultApp'),
                ' to select the PyTune Safari Helper as your RSS reader. Then loading an RSS ',
                'feed in Safari will open the feed in PyTune. Simple!'
              ])
            ]),
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('a', {
                  className: 'NB-goodies-safari-notifier NB-modal-submit-button NB-modal-submit-green',
                  href: 'https://github.com/anaconda/PyTune-Counter'
              }, 'Download'),
              $.make('div', { className: 'NB-goodies-safari' }),
              $.make('div', { className: 'NB-goodies-title' }, 'Safari: PyTune unread count notifier'),
              $.make('div', { className: 'NB-goodies-subtitle' }, 'Safari extension to show on the toolbar how many unread stories are waiting for you on PyTune.')
            ]),
            ...
            $.make('div', { className: 'NB-goodies-group NB-modal-submit' }, [
              $.make('input', {
                  ...
                  value: 'http://www.pytune.com/?url=BLOG_URL_GOES_HERE'
              }),
