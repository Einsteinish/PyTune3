PYTUNE.ReaderSendEmail = function(story, options) {
    var defaults = {};
...
PYTUNE.ReaderSendEmail.prototype = new PYTUNE.Modal;

_.extend(PYTUNE.ReaderSendEmail.prototype, {
          ...
          ($.cookie('NB:email:to') || "") })
            ...
            $.make('div', { className: 'NB-modal-email-from-container' }, [
              $.make('div', [
                ...
                $.make('input', { className: 'NB-input NB-modal-email-from', name: 'from_name', id: 'NB-send-email-from-name', value: this.model.preference('full_name') || PYTUNE.Globals.username || '' })
              ]),
              $.make('div', { style: 'margin-top: 8px' }, [
                $.make('label', { 'for': 'NB-send-email-from-email' }, [
                  ' Your email: '
                ]),
                $.make('input', { className: 'NB-input NB-modal-email-from', name: 'from_email', id: 'NB-send-email-from-email', value: PYTUNE.Globals.email || this.model.preference('email') || '' })
              ]),
              $.make('div', { style: 'margin-top: 8px' }, [
