...
(function() {
    window.PYTUNE = window.PYTUNE || {};
    var exports = undefined;

    {% comment %}
    {% include_bookmarklet_js %}
    {% endcomment %}
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/jquery.noConflict.js"></script>
    ...
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/jquery.url.js"></script>
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/underscore-1.4.3.js"></script>
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/underscore.noconflict.js"></script>
    <script type="text/javascript" src="{{ MEDIA_URL }}js/vendor/readability-1.7.1.modified.js"></script>


    PYTUNE.Bookmarklet = function(options) {
        var defaults = {};
    ...
    PYTUNE.Bookmarklet.prototype = {
        ...
        runner: function() {
            ...
            if (this.check_if_on_pytune()) {
                var message = "This bookmarklet is successfully installed.\nClick it while on a site you want to read in PyTune.";
                this.alert(message);
                return this.close();
            }
            ...
            var $comment = $('textarea[name=pytune_comment]', this.$modal);
        ...
        make_modal: function() {
            ...
            this.$modal = $.make('div', { className: 'NB-bookmarklet NB-modal' }, [
                ...
                $.make('div', { className: 'NB-modal-title' }, 'Share this story on PyTune'),
                    ...
                    $.make('div', { className: 'NB-bookmarklet-page' }, [
                        ...
                        $.make('div', { className: 'NB-bookmarklet-page-comment NB-modal-submit' }, [
                            ...
                            $.make('div', { className: 'NB-bookmarklet-comment-input' }, [
                                $.make('textarea', { name: 'pytune_comment', placeholder: "Comments..." })
                            ]),
        ...
        show_error: function() {
            ...
            $('.NB-modal-submit', this.$modal).html($.make('div', { className: 'NB-error-invalid' }, [
                ...
                $.make('a', { href: 'http://www.pytune.com/?next=goodies' }, 'Goodies on PyTune'),
                '.'
            ]));
        },
        ...
        pre_share_check_story: function() {
            ...
            var $comments = $('textarea[name=pytune_comment]', this.$modal);
        ...
        make_shared_story: function(story) {
            ...
            var $story = $.make('a', { 
                ...
                href: story.pytuneblog_permalink,
                target: '_blank'
            }, [
                $.make('img', { src: user.photo_url }),
        ...
        share_story: function(disable_https) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    comments: $('textarea[name=pytune_comment]', this.$modal).val(),
        ...
        attach_css: function() {
            ...
            var style = '<style id="pytune_bookmarklet_css">' + css + '</style>';
            if ($('#pytune_bookmarklet_css').length) {
                $('#pytune_bookmarklet_css').replaceWith(style);
            } else if ($('head').length) {
                $('head').append(style);
            } else {
                $('body').append(style);
    ...
    if (PYTUNE.bookmarklet && PYTUNE.bookmarklet.active) {
        PYTUNE.bookmarklet.fix_title();
        return;
    }
    PYTUNE.bookmarklet = new PYTUNE.Bookmarklet();
