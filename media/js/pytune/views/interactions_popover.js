PYTUNE.InteractionsPopover = PYTUNE.ReaderPopover.extend({
    ...
    close: function() {
        ...
        PYTUNE.app.sidebar_header.update_interactions_count(0);
        this.model.preference('dashboard_date', new Date);
        PYTUNE.ReaderPopover.prototype.close.call(this);
    },
