PYTUNE.Views.SocialPageComment = Backbone.View.extend({
    ...
    open_reply: function(options) {
        ...
        if (PYTUNE.Globals.pytuneblog_protected && !PYTUNE.Globals.pytuneblog_following) {
            var $error = this.$('.NB-story-comment-error');
            $error.text("You must be following " + PYTUNE.Globals.pytuneblog_username + " to reply");
            return;
        }
