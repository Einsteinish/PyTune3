PYTUNE.Models.User = Backbone.Model.extend({
    
    get: function(attr) {
        var value = Backbone.Model.prototype.get.call(this, attr);
        if (attr == 'photo_url' && !value) {
            value = PYTUNE.Globals.MEDIA_URL + 'img/reader/default_profile_photo.png';
        }
        return value;
    },
...
PYTUNE.Collections.Users = Backbone.Collection.extend({
    
    model : PYTUNE.Models.User,
