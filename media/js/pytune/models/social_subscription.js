PYTUNE.Models.SocialSubscription = Backbone.Model.extend({
    ...
    on_change: function() {
        PYTUNE.log(['Social Feed Change', this.changedAttributes(), this.previousAttributes()]);
    },
    
    on_remove: function() {
        PYTUNE.log(["Remove Feed", this, this.views]);
        _.each(this.views, function(view) { view.remove(); });
    },
    
    update_counts: function() {
        PYTUNE.assets.social_feeds.trigger('change:counts');
    },
...
PYTUNE.Collections.SocialSubscriptions = Backbone.Collection.extend({
    
    model : PYTUNE.Models.SocialSubscription,
    ...
    comparator: function(a, b) {
        var sort_order = PYTUNE.reader.model.preference('feed_order');
