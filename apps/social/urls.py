...
urlpatterns = patterns('',
    url(r'^river_stories/?$', views.load_river_pytuneblog, name='social-river-pytuneblog'),
    ...
    url(r'^save_pytuneblog_settings/?$', views.save_pytuneblog_settings, name='save-pytuneblog-settings'),
