PYTUNE.Views.SocialPageComments = Backbone.View.extend({
    ...
    attach_comments: function($comments) {
        ...
        $comments.each(function() {
            var $comment = $(this);
            var comment = new PYTUNE.Models.Comment({
                id: $comment.data('id'),
                user_id: $comment.data('userId')
            });
            var comment_view = new PYTUNE.Views.SocialPageComment({
                el: $comment,
                on_social_page: true,
                story: self.model,
    ...
    load_public_story_comments: function() {
        $.get('/social/public_comments', {
            ...
            user_id: PYTUNE.Globals.pytuneblog_user_id,
            format: "html"
