PYTUNE.Views.SocialPage = Backbone.View.extend({
    ...
    initialize: function() {
        PYTUNE.assets = new PYTUNE.SocialPageAssets();
        ...
        this.login_view = new PYTUNE.Views.SocialPageLoginSignupView({
            el: this.el
        });
    ...
    initialize_stories: function($stories) {
        ...
        $('.NB-shared-story', $stories).each(function() {
            ...
            if (!self.stories[guid]) {
                var story_view = new PYTUNE.Views.SocialPageStory({
                    el: $(this),
                    page_view: self
                });
    ...
    find_story: function() {
        var search_story_guid = PYTUNE.router.story_guid;
    ...
    follow_user: function() {
        ...
        PYTUNE.assets.follow_user(PYTUNE.Globals.pytuneblog_user_id, _.bind(function(data) {
            var message = 'You are now following ' + PYTUNE.Globals.pytuneblog_username;
            if (data.follow_profile.requested_follow) {
                message = 'Your request to follow ' + PYTUNE.Globals.pytuneblog_username + ' has been sent';
            }
    ...
    unfollow_user: function() {
        ...
        PYTUNE.assets.unfollow_user(PYTUNE.Globals.pytuneblog_user_id, _.bind(function(data) {
            $button.html('Follow ' + PYTUNE.Globals.pytuneblog_username).removeClass('NB-button-following')
...
$(document).ready(function() {
    ...
    PYTUNE.app.social_page = new PYTUNE.Views.SocialPage();
